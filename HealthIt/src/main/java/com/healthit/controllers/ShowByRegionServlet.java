...
/**
 * Servlet implementation class ShowByRegionServlet
 */
@WebServlet("/showbyregion")
public class ShowByRegionServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowByRegionServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		fruitList=iFruitService.getByRegion(region);
